...
public class LCIMChatItemHolder extends LCIMCommonViewHolder {
  ...
  public void bindData(Object o) {
    ...
    LCIMProfileCache.getInstance().getCachedUser(message.getFrom(), new AVCallback<Goods>() {
      @Override
...
//          Log.e("kk", "name" + userProfile.getUserName());
        ...
        if (!isLeft){
          if (currentUser != null){
            String avatarUrl = currentUser.getAVFile("avatar").getUrl();
            if (!TextUtils.isEmpty(avatarUrl)) {
